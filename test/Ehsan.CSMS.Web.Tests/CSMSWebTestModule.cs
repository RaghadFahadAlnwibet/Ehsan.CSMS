...
[DependsOn(
    ...
    typeof(CSMSWebModule),
    typeof(CSMSApplicationTestModule),
    typeof(CSMSEntityFrameworkCoreTestModule)
)]
public class CSMSWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(CSMSWebModule).Assembly));
        });
