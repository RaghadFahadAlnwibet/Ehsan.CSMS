...
namespace Ehsan.CSMS.Migrations
{
    ...
    [Migration("20250325020522_Add_NetPriceAndDiscount_Invoice")]
    partial class Add_NetPriceAndDiscount_Invoice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ehsan.CSMS.Entities.OrderDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreationTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasColumnName("OrderDetail_Date")
                        .HasDefaultValueSql("GetDate()");
            ...
            modelBuilder.Entity("Ehsan.CSMS.Entities.Order", b =>
                {
                    ...
                    b.HasOne("Ehsan.CSMS.Entities.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Ehsan.CSMS.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Ehsan.CSMS.Entities.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("Ehsan.CSMS.Entities.Product", b =>
                {
                    b.HasOne("Ehsan.CSMS.Entities.Category", "Category")
                        .WithMany("Products")
